## This is the R code used to generate one of the required plots, plot1, for
...
# -----------------------------------------------------------
# Step 3: Drawing plot 1 (Histogram of Global Active Power in kwatt)
# -----------------------------------------------------------
...
# -----------------------------------------------------------
# Step 4:Copying the plot to a png image "plot1.png"
# -----------------------------------------------------------
